...
--------------------------------------------------------------------------------
"""
"""\ !!Attention!! calculates system performance scores, by comparing the gold standard
# to a system results file, of which an example is provided as example results file.txt. 
# Score this file by calling: \python eval ir.py cacm gold std.txt example results file.txt"
